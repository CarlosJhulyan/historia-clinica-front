...
import { fracturaTipo } from '../../constants/Odontograma';
...
export const ModalSiete = (props) => {
    const { TextArea } = Input;
    /* 'Fractura' || 'Giroversión' */
    ...
    const agregarHallazgo = () => {
        const data = {
            tipo: (tipo === "Raiz y Coronal") ? fracturaTipo.raizCoronal : tipo,
            diente: numero,
