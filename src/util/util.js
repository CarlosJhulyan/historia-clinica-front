...
// convertir 24hrs a 12hrs ejemplo 18:00 -> 6:00 pm
export const convertir24hrsa12hrs = hora => {
	const hora24 = moment(hora, 'HH:mm');
	const hora12 = hora24.format('hh:mmA');
	return hora12;
};
...
export const openNotification = (titulo, texto, tipo) => {
	...
	notification.open({
		...
		icon: tipo === 'Alerta' ? <CloseCircleOutlined /> : tipo === 'Warning' ? <WarningOutlined /> : <CheckCircleOutlined />,
		message: titulo,
		description: texto,
		key,
	});
