					...
					>
									...
									return (
										<div>
											...
											<Row style={{ marginTop: espacios - 30, marginLeft: 30 }}>
												<Col xs={24}>
													<strong style={{ fontWeight: 600 }}>U/M: </strong>
													{tratamiento.unidvta}
												</Col>
											</Row>
											<Row style={{ marginTop: espacios - 30, marginLeft: 30 }}>
												<Col xs={8}>
													<strong style={{ fontWeight: 600 }}>DOSIS: </strong>
													{tratamiento.dosis}
												</Col>
												<Col xs={8}>
													<strong style={{ fontWeight: 600 }}>CADA: </strong>{' '}
													{tratamiento.frecuencia} HRS
												</Col>
												<Col xs={8}>
													<strong style={{ fontWeight: 600 }}>VIA: </strong>
													{tratamiento.etiquetaVia}
												</Col>
											</Row>
											<Row style={{ marginTop: espacios - 30, marginLeft: 30 }}>
												<Col xs={8}>
													<strong style={{ fontWeight: 600 }}>DIAS: </strong>
											...
											<Row style={{ marginTop: espacios - 20, marginLeft: 10 }}>
												...
												<Col xs={24}>
													-{' '}
													{tratamiento.recomendacionAplicar !== ''
														? tratamiento.recomendacionAplicar
														: sinRegistro}
												</Col>
											</Row>
						...
						{tratamientoDetalle.length > 0 && tratamientoDetalle.length <= 3 && (
							<Row style={{ marginTop: espacios, marginLeft: 10 }}>
								...
								<Col xs={24}>
									1.{' '}
									{tratamiento.indicacionesgen.trim() !== ''
									...
									if (index > 2 && index <= 6) {
										return (
											<div>
												...
												<Row style={{ marginTop: espacios - 20, marginLeft: 30 }}>
													<Col xs={24}>
														<strong style={{ fontWeight: 600 }}>DCI: </strong>{' '}
														{tratamiento.descprod}
													</Col>
												</Row>
