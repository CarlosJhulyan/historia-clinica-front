...
export const ImpresionLaboratorio = ({ datosModal, firma, cmp }) => {
	const fuente = 17;
	const espacios = 35;
	...
	const { dataProcedimiento, recomendacion } = useSelector(state => state.laboratorio);
				...
				<div style={{ position: 'relative' }}>
					...
					>
						<div style={{ width: '100%', textAlign: 'center', paddingRight: 50 }}>
							<strong style={{ fontSize: '30px' }}>LABORATORIO</strong>
						</div>
