...
import { DIENTES_INFANTE_INFERIOR } from "../../../constants/Dientes";
import { DienteAdulto } from "../../../models/DienteAdulto";
import { dibujarDientes } from "../dibujarDientes";
import DienteContenedorInferior from "../dienteContenedor/DienteContenedorInferior";
import { ModalError } from "../../../components/modal/ModalError";
import { obtenerInicioFin } from "../../../models/Diente";

const DientesInfanteInferior = () => {
  ...
  const mapaDiente = dibujarDientes(stateDiente, "inferior");
  ...
  return (
    <div className="parent">
      {
        DIENTES_INFANTE_INFERIOR.map((dienteInfante, index) =>
...
export default DientesInfanteInferior;
