...
import { DIENTES_ADULTO_INFERIOR } from "../../../constants/Dientes";
...
const DientesAdultoInferior = () => {
  ...
  return (
    <div className="parent">
      {
        DIENTES_ADULTO_INFERIOR.map((dienteAdulto, index) =>
...
export default DientesAdultoInferior;
