...
function ModalListaProductos({ visible, setVisible, chargeDetailsModalProducto }) {
    ...
    onSelect: (recordSelect, into, selectedRows) => {
      if (into) {
        ...
        confirm({
          ...
          centered: true,
          content: 'Se eliminará los datos guardados del producto, ¿Está seguro de querer quitar este producto?',
          onOk() {
