      ...
      >
        <Row justify='space-between' style={{ marginTop: 10, marginLeft: 0, marginRight: 20 }}>
          <Col span={18}>
                  ...
                  <Col span={18}>
                    ...
                    <Form labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
                      ...
                      <Form.Item label='Apellidos' style={{margin: 0}}>
                        <Input disabled size='small' value={`${pacienteCurrent.APE_PATERNO ? pacienteCurrent.APE_PATERNO : ''} ${pacienteCurrent.APE_MATERNO ? pacienteCurrent.APE_MATERNO : ''}`} />
                      </Form.Item>
                    </Form>
                  </Col>
                  <Col span={6}>
            ...
            <Divider />
            <span style={{color: 'red'}}>Para ingresar  los datos de Médico y Paciente, hacer CLICK en las imágenes</span>
            <Divider />
            <Row>
              <Col span={5}>
                <br/>
                ...
                <Form>
                  <Radio.Group value={tipoVenta} onChange={(e) => setTipoVenta(e.target.value)}>
                    <Space direction="vertical">
                      <Radio disabled value={1}>Ticket</Radio>
                ...
                <Form labelCol={{ span: 5 }} wrapperCol={{ span: 19 }}>
                  <Form.Item label="Documento" style={{margin: 0}}>
                    <Input
                      ...
                      addonAfter={<span onClick={() => setVisibleModalCliente(true)}>Seleccionar Cliente</span>}
                      size='small'
                      disabled
